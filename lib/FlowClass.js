            ...
            value: function end() {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    .then(setStepsTakenToOne).then(function () {
                        ...
                        // 2.
                        var jobHandlerPromises = _this.jobHandlers.map(function (promiseReturner) {
                    ...
                    if (job) {
                        ...
                        _this.FlowModel.findByIdAndUpdate(_this.flowId, {
                            ...
                            if (err) {
                                ...
                                _this.activeJobs = _.remove(_this.activeJobs, function (activeJob) {
            ...
            value: function cancel(cancellationData) {
                ...
                return Promise.all(_this.promised['0']).then(function () {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        _this.activeJobs.forEach(function (job) {
