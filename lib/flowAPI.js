...
function flowAPIBuilder(queue, mongoCon, FloughInstance) {
    ...
    function registerFlow(flowType, flowOptions, flowFunc, dynamicPropFunc) {
        ...
        FloughInstance.dynamicPropFuncs[flowType] = dynamicPropFunc;
        FloughInstance.jobOptions[flowType] = flowOptions;
    ...
    function createFlowJob(flowType, data) {
        ...
        return new Promise(function (resolve, reject) {
            var dynamicPropFunc = FloughInstance.dynamicPropFuncs[flowType];

            var jobOptions = FloughInstance.jobOptions[flowType];
