    ...
    if (FloughInstance) {
        ...
        return {
            ...
            init(o) {
                ...
                .then(queue => [queue, setupStorage(Flough), setupRedis(Flough)]).spread((queue, storageClient, redisClient) => {

                    // Setup search functionality for Flough Class
                    let searchFunctions = require('./searcher')(queue, redisClient, Flough.prototype.o, Flough.prototype.storageClient);
